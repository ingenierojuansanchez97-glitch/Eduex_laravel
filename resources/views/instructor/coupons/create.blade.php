        ...
        <div class="dashboard-layout">
            ...
            <div class="dashboard-main">
                ...
                <div class="dashboard-header wow fadeInUp">
                    <div class="section-title-area text-left">
                        <div class="section-title">
                            ...
                            <h2>{{ __('instructor.create_coupon') }}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard-courses-section wow fadeInUp" data-wow-delay="0.1s" style="margin-top: 30px;">
                    <form class="settings-form" action="{{ route('instructor.coupons.store') }}" method="POST" style="background: #fff; padding: 30px; border-radius: 8px; border: 1px solid #f1f5f9;">
                        @csrf

                        <div class="form-group mb-4">
                            <label for="code" style="font-weight: 600; display: block; margin-bottom: 8px;">Coupon Code <span class="text-danger">*</span></label>
                            <input type="text" id="code" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="e.g. MYCOURSE50" required style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 4px;">
                        ...
                        <div style="display: flex; gap: 20px; flex-wrap: wrap;" class="mb-4">
                            ...
                            <div class="form-group" style="flex: 1; min-width: 250px;">
                                ...
                                <input type="number" id="value" name="value" step="0.01" min="0" class="form-control @error('value') is-invalid @enderror" value="{{ old('value') }}" placeholder="e.g. 10.00" required style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 4px;">
                                @error('value')
                                    <span class="text-danger" style="font-size: 13px;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div style="display: flex; gap: 20px; flex-wrap: wrap;" class="mb-4">
                            ...
                            <div class="form-group" style="flex: 1; min-width: 250px;">
                                ...
                                <input type="number" id="usage_limit" name="usage_limit" min="1" class="form-control @error('usage_limit') is-invalid @enderror" value="{{ old('usage_limit') }}" placeholder="Unlimited if empty" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 4px;">
                                @error('usage_limit')
                                    <span class="text-danger" style="font-size: 13px;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div style="display: flex; gap: 20px; flex-wrap: wrap;" class="mb-5">
                            <div class="form-group" style="flex: 1; min-width: 250px;">
                                ...
                                <input type="datetime-local" id="valid_from" name="valid_from" class="form-control @error('valid_from') is-invalid @enderror" value="{{ old('valid_from') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 4px;">
                                @error('valid_from')
                                    <span class="text-danger" style="font-size: 13px;">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group" style="flex: 1; min-width: 250px;">
                                ...
                                <input type="datetime-local" id="valid_to" name="valid_to" class="form-control @error('valid_to') is-invalid @enderror" value="{{ old('valid_to') }}" style="width: 100%; padding: 10px; border: 1px solid #cbd5e1; border-radius: 4px;">
                                @error('valid_to')
                                    <span class="text-danger" style="font-size: 13px;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-actions" style="border-top: 1px solid #f1f5f9; padding-top: 20px; text-align: right;">
                            ...
                            <button type="submit" class="theme-btn style-2" style="padding: 10px 20px; border-radius: 4px;">Create Coupon</button>
                        </div>
                    </form>
                </div>
            </div>
